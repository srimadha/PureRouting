...
public class EdgeInfo {
	...
	public boolean isFix() {
		...
		if (getHighway().equals(OSMParam.MOTORWAY) || 
			getHighway().equals(OSMParam.TRUNK) ||
			getHighway().equals(OSMParam.MOTORWAY_LINK) || 
			getHighway().equals(OSMParam.TRUNK_LINK) ||
			getHighway().equals(OSMParam.PRIMARY) ||
			getHighway().equals(OSMParam.SECONDARY) ||
			getHighway().equals(OSMParam.TERTIARY) ||
			getHighway().equals(OSMParam.PRIMARY_LINK) ||
			getHighway().equals(OSMParam.SECONDARY_LINK) ||
			getHighway().equals(OSMParam.TERTIARY_LINK)) {
			isFix = false;
		}
		return isFix;
	}
